...
class Receitas extends AbstractApi
{
    
    /**
     * Array com itens que ser�o adicionados ao boleto
     * @var array
     */ 
     ...
     * @param int $conta ID da conta banc�ria a qual este item ser� gerada
     * @param int $servico ID do servi�o referente ao item
     * @param float $valor Valor do item
     * @param int $quantidade Utilizado para multiplicar o valor do item
     * @param string $complemento Complemento do item que ser� exibido na composi��o do boleto
     ...
     * @param mixed $identificadorDoCliente Identificador do cliente cadastrado no software
     * @param int $servico ID do servi�o referente ao item
     * @param float $valorUnitario Valor do unit�rio do item
     * @param int $conta ID da conta banc�ria a qual este item ser� gerada     
     * @param string $dataInicio Data de inicio do item recorrente no padr�o m/d/Y
     * @param int OPCIONAL $periodicidade Periodicidade do item ( 30 = mensal, 60=bimestral, 90=trimestral, 180=semestral, 365=anual )
     * @param int OPCIONAL $quantidade Quantidade do item ( ser� multiplicado sempre Qtd*VlUnit )
     * @param string OPCIONAL $complemento Complemento do item recorrente
     * @param string $dataFim Data de fim do item recorrente no padr�o m/d/Y
    ...
    public function novaRecorrente( $identificadorDoCliente, $servico, $valorUnitario, $conta, $dataInicio, $periodicidade = 30,  $quantidade = 1, $complemento = null, $dataFim = null){
        ...
        switch ( $periodicidade ){
            ...
            case 365:
                ...
                break;
            default:
                throw new Exception('Per�odicidade "'.$periodicidade.'" inv�lida. Aceita somente 30,60,90,180 e 365 dias.');
        }
    ...
    /**
     * Adiciona um novo item a cobran�a que ser� inserida
     * 
     * @param int $servico Id do servi�o
    ...
    /**
     * Gera a cobran�a de acordo com os itens adicionados anteriomente pelas chamadas a fun��o 'nova'
     * 
     ...
     * @return array Informa��es da cobran�a gerada incluindo link de segunda via
     */
    ...
    /**
     * Gera uma cobran�a a ser cobrada pelo cart�o do cliente
     * 
     * @param string $identificadorDoCliente
     * @param string $vencimento Data no formato m/d/Y
     * @param int $conta
     ...
     * @param string $obsInterna
     * @param string $obsParaCliente
     * @return int Retorna o id da cobran�a gerada
     */
    ...
    /**
     * Executa a requisi��o em cobran�a put
     * @param array $dados
     * @return int ID da cobran�a inserida  
     */
    ...
    /**
     * Retorna um array com todos campos necess�rios para inserir uma cobran�a
     * 
     * @param string $identificadorDoCliente
     * @param string $vencimento Data no formato m/d/Y
     * @param int $conta
