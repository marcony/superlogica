...
class Api {
    ...
    /**
     * Armazena o nome da licen�a utilizada
     * @var string
     */
    protected $_licenca = '';
    
    /**
     * Armazena o retorna da ultima requisi��o
     * Utilizado nas outras fun��es como getData, getMsg e getStatus
     * @var array
     */
    ...
    /**
     * Retorna a url do aplicativo que est� sendo utilizado
     * @return string
     */
     ...
     * Utilizado no caso de multiple response e � ncess�rio apenas o primeiro item da requisi��o
     * 
     * FUNCIONANDO COMO NO JS_REQUEST 
     * 
     * @param array|int $retornoOuIndice um array de retorno ou o �ndice do data a ser retornado
     * @return array
     */
    public function getData( $retornoOuIndice = '0' ){   
        
        // Mantendo compatibilidade com c�digo anterior
    ...
    /**
     * Verifica se a requisi��o � v�lida
     * @return bool
     */
